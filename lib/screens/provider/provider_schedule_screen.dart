                      ...
                      builder: (context, snapshot) {
                        ...
                        for (final booking in schedules) {
                          ...
                          if (status == 'completed' ||
                              status == 'rejected' ||
                              status == 'cancelled') {
                            // Monthly auto-reset: only show this month's
                            // completed/rejected jobs here. Older ones
                            // remain permanently visible in "Job History
                            // & Ratings & Feedback" instead.
                            final finishedAt =
                                booking.completedAt ?? booking.updatedAt;
                            final isThisMonth =
                                finishedAt.year == now.year &&
                          ...
                          // Pending/accepted bookings always stay visible
                          // here, regardless of date, until they're
                          // actually completed.
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: OutlinedButton(
                            onPressed: () async {
                              final success = await showDeclineBookingDialog(
                                context: context,
                                bookingId: booking.id,
                ...
                if (status == 'pending' || status == 'accepted') ...[
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () async {
                        final success = await showRescheduleBookingDialog(
                          context: context,
                          bookingId: booking.id,
                          serviceName: booking.service,
