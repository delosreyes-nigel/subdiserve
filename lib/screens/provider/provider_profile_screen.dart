              ...
              child: Column(
                ...
                children: [
                          ...
                          children: [
                            ...
                            if (isApproved) ...[
                              ...
                              StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                                stream: ReviewService().streamProviderRating(
                                    FirebaseAuth.instance.currentUser!.uid),
                                builder: (context, ratingSnapshot) {
                                  final ratingData = ratingSnapshot.data?.data();
                                  final double avgRating =
                                      ((ratingData?['averageRating'] ?? 0) as num)
                                          .toDouble();
                                  final int ratingCount =
                                      (ratingData?['ratingCount'] ?? 0) as int;
                                  ...
                                  return Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          ratingCount > 0
                                              ? '${avgRating.toStringAsFixed(1)} Rating ($ratingCount)'
                                              : 'No ratings yet',
                                          style: GoogleFonts.poppins(
                                            color: const Color(0xFFF59E0B),
                                            fontSize: 11,
                  ...
                  _buildActionTile(
                    ...
                    title: 'Job History & Ratings & Feedback',
